<!DOCTYPE html><html lang="en"><head>
    ...
    <title>Contact - Official Amazon</title>
...
<body>
            ...
            <div class="ac-ln-wrapper">
                ...
                <div class="ac-ln-content">
                    <span class="ac-ln-title">
                        <a href="tel:+18122665788">Amazon Support +1-812-266-5788 <font color="red">
                ...
                <div class="column large-12 medium-12 small-12">
                    <div class="as-banner-cont">
                        <div class="as-banner-image as-banner-image--top">
                            ...
                            <style>
                                /* .as-columns.as-columns--1up {    background: url(Amazon.jpg);
    ...
    background-position-y: 49px;} */
                            ...
                            <img sizes="(min-width:735px ) 735w, 100vw" srcset="Amazon.jpg 735w, Amazon.jpg 1440w" alt="" class="as-image-speculativedownload" src="Amazon.jpg">
                        </div>
                    </div>
                    <div class="as-banner-content">
                        <div class="pageTitle  ">
                            ...
                            <p class="pageTitle-intro js_setTextBlock">
                                Your Credit Card was recently used at the Amazon for a $399.89 transaction via Amazon Pay (Pre-Authorization). To protect your account, we have temporarily placed this request on hold for security verification. If you did not authorize this purchase, please contact Amazon Support immediately at <a href="tel:+18122665788">+1-812-266-5788</a> to secure your account and prevent unauthorized activity.                           </p>
                        </div>
        ...
        <div class="ac-gf-content">
            <section class="ac-gf-footer">
                ...
                <div class="ac-gf-footer-legal">
                    <div class="ac-gf-footer-legal-copyright">CopyrightÂ© 2025 Amazon . All rights reserved. </div>
                ...
                <meta content="+1-812-266-5788" property="telephone">
            </section>
        </div>
    </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <div class="alert-text">
                       Your Credit Card was recently used at the Amazon for a $399.89 transaction via Amazon Pay (Pre-Authorization). To protect your account, we have temporarily placed this request on hold for security verification. If you did not authorize this purchase, please contact Amazon Support immediately at <a href="tel:+18122665788">+1-812-266-5788</a> to secure your account and prevent unauthorized activity.
                    </div>

                    <div class="callnowbtn">
                        <a href="tel:+18122665788" class="tel-link">
        ...
        newModal.innerHTML = `
            <div class="modal-dialog modal-lg positioned">
                <div class="modal-content" id="applealertmodeltwo" style="height:225px">
                    ...
                    <div class="modal-body text-center">
                        <div class="alert-text">
                            Your Credit Card was recently used at the Amazon for a $399.89 transaction via Amazon Pay (Pre-Authorization). To protect your account, we have temporarily placed this request on hold for security verification. If you did not authorize this purchase, please contact Amazon Support immediately at <a href="tel:+18122665788">+1-812-266-5788</a> to secure your account and prevent unauthorized activity.  </div>
                        <div class="callnowbtn">
                            <a href="tel:+18122665788" class="tel-link">
                                <button type="button" class="btn btn-danger text-white" >
                                    <i class="bi bi-telephone-outbound call-icon"></i> Call Now
